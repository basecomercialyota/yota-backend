...
const CONFIG = {
  ...
  ESTAGIO_VENDA      : 'C22:UC_96B9D5',   // FINALIZAÇÃO — única fonte de verdade para venda
  ...
  ESTAGIO_IGNORADO: 'C22:UC_54VG0E',
...
async function getDeals(dataInicio, dataFim) {
  ...
  return deals.filter(d => d.STAGE_ID !== CONFIG.ESTAGIO_IGNORADO);
}
